        ...
        function onRequest(context) {
            ...
            if (context.request.method === 'GET') {
                ...
                let form = serverWidget.createForm({
                    title: `Create POs from Manufacturing Orders`
                });
                form.clientScriptModulePath = '/SuiteScripts/purchase order/DashboardClient_wopo.js';
                ...
                var typeofpo = form.addField({
                    id: "custpage_typeofpo",
                    type: serverWidget.FieldType.SELECT,
                    label: "Type of PO",
                    source: "customrecord_typepo"
                    });
                typeofpo.defaultValue = 1;
