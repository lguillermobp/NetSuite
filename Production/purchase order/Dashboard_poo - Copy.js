...
define(['N/file','N/redirect',"N/runtime","N/ui/serverWidget", "N/record", "N/search", "N/file", "N/error",'N/log', "/SuiteScripts/Modules/generaltoolsv1.js", "/SuiteScripts/Modules/LoDash.js"],
	...
	function (file, redirect, runtime,serverWidget,record, search, file, error,log, GENERALTOOLS,  _) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method === 'GET') {
                ...
                var wppdpons = sublistpm.addField({
                    id: "custrecordml_ppdpons",
                    type: serverWidget.FieldType.TEXT,
                    label:'PPDPONS'
                });
                wppdpons.updateDisplayType({
                    displayType: serverWidget.FieldDisplayType.HIDDEN
                });
                var ppdpodn = sublistpm.addField({
                    id: "custrecordml_ppdpon",
                    type: serverWidget.FieldType.TEXT,
                    label:'PPDPO'
                });
                ...
                var counter = 0;
                log.debug("summarypos",summarypos);
                ...
                //======================================================================================================
                    ...
                    var wppdpons=sublistppd.addField({
                        id: "custrecordml_ppdpons",
                        type: serverWidget.FieldType.TEXT,
                        label:'PPDPONS'
                    });
                    ...
                    var memoww=sublistppd.addField({
                        id: "custrecordml_memo",
                        type: serverWidget.FieldType.TEXT,
                        label:'Project'
                    });
                    memoww.updateDisplayType({
                        displayType: serverWidget.FieldDisplayType.HIDDEN
                    });
                    sublistppd.addField({
                        id: "custrecordml_poid",
	...
	function findCases1() {
                ...
                {  
                    ...
                    if (index==-1)
                    ...
                    else 
                        {
                            ...
                            wmemo=summarypos[index].memo+"; " + memo;
                            summarypos[index] = {
        ...
        if (procesar=="Y")
            ...
            pagedatas = _.orderBy(pagedatas,  ['ppdpo', 'item'], ['asc', 'desc']);
		return pagedatas;
	}
