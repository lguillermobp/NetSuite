...
define(['N/search',"N/ui/message","N/runtime","N/currentRecord", "N/error", "N/log",'N/url', 'N/record'],
    /**
     *
     * @param currentRecord
     * @param error
     */
    function (s,message,runtime,currentRecord, error, log, url, record) {
        ...
        function saveRecord(context) {
            ...
            var idemp = currRec.getValue({fieldId: "custpage_userid"});

            var script = 'customscript_dashboard_po';
            var deployment = 'customdeploy1';
            var parameters = "";
