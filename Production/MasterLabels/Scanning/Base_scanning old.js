 ...
 */
 ...
 define(["N/error","N/format", "N/search", "N/file", "N/log","N/runtime",'N/record', "/SuiteScripts/Modules/generaltoolsv1.js", "/SuiteScripts/MasterLabels/Tools/masterlabeltools.js"],
 /**
  *
  * @param error
  * @param search
 ...
 function (error, format, search, file, log, runtime, record , GENERALTOOLS, MLTOOLS) {
     ...
     function createXmlString(MasterLabelsData) {
         ...
         let baseXmlString = file.load({id: "/SuiteScripts/MasterLabels/Form/PalletTagHSN.html"}).getContents();
         let xmlString = "";
     ...
     function createXmlStringForHTML2(MasterLabelsData) {
         ...
         let bigFacelessReportUrl = ``;
         let baseXmlString = file.load({id: "/SuiteScripts/MasterLabels/Form/PalletTagHSN2.html"}).getContents();
         let xmlString = "";
...
// **********************************
                  ...
                  /*       if (invAssignmentLineCount) {
                    ...
                    log.debug("6-inventoryDetailSubRecord",inventoryDetailSubRecord);
                     ...
                     if (requiredQuantity) {
                         ...
                         isok=deleteab(abrec);
                         throw new Error("Required quantity for item: ".concat(itemText, " cannot be fulfilled IDs= "+ abrec+ " WO ID:" + woId));
                     }
                 }
             }
         };
     ...
     function nextletter(c) {
         ...
         result= c.substr(0, cl-1)+String.fromCharCode(c.charCodeAt(cl-1) + 1);
         if (c.charCodeAt(cl-1)>89) {result="A".repeat(cl+1);}
         return result;
     }
