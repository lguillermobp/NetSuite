 ...
 * @classdescription Encapsulates an email merge result.
 * @protected
 * @constructor
 *
 * @since 2015.2
 ...
 * @classdescription Encapsulates a template engine object that produces HTML and PDF printed forms utilizing advanced PDF/HTML template capabilities.
 * @protected
 * @constructor
 *
 * @since 2015.2
...
function TemplateRenderer() {
     ...
     * @since 2015.2
     */    
    this.prototype.renderPdfToResponse = function(options) {};    
