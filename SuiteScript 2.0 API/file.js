...
function File() {
     ...
     * @return {Iterator}
     */    
    this.prototype.getSegments = function(options) {};    
    
    /**
     * Returns reader object for performing special read operations
     * @return {Reader}
     */    
    this.prototype.getReader = function() {};    
     ...
     * @return {string}
     */    
    this.prototype.getContents = function() {};    
     ...
     * @since 2017.1
     */    
    this.prototype.resetStream = function() {};    
...
function Reader() {
     ...
     * @return {string}
     */    
    this.prototype.readUntil = function(options) {};    
     ...
     * @return {string}
     */    
    this.prototype.readChars = function(options) {};    
}
